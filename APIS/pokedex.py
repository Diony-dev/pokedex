...
class App(ctk.CTk):
    ...
    'morado': '#800080'
        ...
        self.titulo.grid(column = 0, row = 0, sticky = "n")
        self.img_label = ctk.CTkLabel(self.marco, text="", font=self.fuentes['font2'])
        self.img_label.grid(row=1, column=0, padx=10, pady=10, ipadx=10, ipady = 10)
        ...
        #configuraciones
        #self.marco2.columnconfigure(0, weight=1)
        self.marco2.columnconfigure(1, weight=2)
        #self.marco2.columnconfigure(2, weight=1)
    ...
    def limpiar(self):
        ...
        self.img_label.configure(image="")  # Limpiar la imagen mostrada
